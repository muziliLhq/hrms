        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="form-group form-row">
                    <label for="name" class="col col-form-label">部门名：</label>
                    <div class="col-2">
                        <input type="text" class="form-control" id="name" name="name" autocomplete="off">
                    </div>
                    <label for="remark" class="col col-form-label">remark：</label>
                    <div class="col-2">
...
<script src="${basePath}/js/dept/hrms_dept.js"></script>
</html>